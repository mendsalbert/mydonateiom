    ...
    <Layout>
      <div className="dark:text-gray-300 mt-6">
        ...
        <ul className="py-2">
          <li>
            <p className="py-2">
              <strong className="pt-4 pb-4">Account</strong> means a unique
          ...
          <li>
            <p className="py-2">
              <strong className="pt-4 pb-4">Company</strong> (referred to as
              either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
              &quot;Our&quot; in this Agreement) refers to Sympodium.
            </p>
          </li>
          <li>
            <p className="py-2">
              <strong className="pt-4 pb-4">Cookies</strong> are small files
          ...
          <li>
            <p className="py-2">
              <strong className="pt-4 pb-4">Country</strong> refers to: Ghana
            </p>
          </li>
          <li>
            <p className="py-2">
              <strong className="pt-4 pb-4">Device</strong> means any device
          ...
          <li>
            <p className="py-2">
              <strong className="pt-4 pb-4">Personal Data</strong> is any
          ...
          <li>
            <p className="py-2">
              <strong className="pt-4 pb-4">Service</strong> refers to the
              Website.
            </p>
          </li>
          <li>
            <p className="py-2">
              <strong className="pt-4 pb-4">Service Provider</strong> means any
          ...
          <li>
            <p className="py-2">
              <strong className="pt-4 pb-4">Usage Data</strong> refers to data
          ...
          <li>
            <p className="py-2">
              <strong className="pt-4 pb-4">Website</strong> refers to MyDonate,
              accessible from{' '}
              <a
          ...
          <li>
            <p className="py-2">
              <strong className="pt-4 pb-4">You</strong> means the individual
        ...
        <ul>
          <li>
            <strong className="pt-4 pb-4">Cookies or Browser Cookies.</strong> A
          ...
          <li>
            <strong className="pt-4 pb-4">Flash Cookies.</strong> Certain
          ...
          <li>
            <strong className="pt-4 pb-4">Web Beacons.</strong> Certain sections
        ...
        <ul>
          ...
          <li>
            <p>
              <strong className="pt-4 pb-4">Functionality Cookies</strong>
            </p>
            <p>Type: Persistent Cookies</p>
            <p>Administered by: Us</p>
            <p>
        ...
        <ul>
          ...
          <li>
            <p>
              <strong className="pt-4 pb-4">To manage Your Account:</strong> to
          ...
          <li>
            <p>
              <strong className="pt-4 pb-4">To contact You:</strong> To contact
          ...
          <li>
            <p>
              <strong className="pt-4 pb-4">To provide You</strong> with news,
          ...
          <li>
            <p>
              <strong className="pt-4 pb-4">To manage Your requests:</strong> To
              attend and manage Your requests to Us.
            </p>
          </li>
          <li>
            <p>
              <strong className="pt-4 pb-4">For business transfers:</strong> We
          ...
          <li>
            <p>
              <strong className="pt-4 pb-4">For other purposes</strong>: We may
        ...
        <ul>
          <li>
            <strong className="pt-4 pb-4">With Service Providers:</strong> We
          ...
          <li>
            <strong className="pt-4 pb-4">With Affiliates:</strong> We may share
          ...
          <li>
            <strong className="pt-4 pb-4">With business partners:</strong> We
            may share Your information with Our business partners to offer You
            certain products, services or promotions.
          </li>
          <li>
            <strong className="pt-4 pb-4">With other users:</strong> when You
          ...
          <li>
            <strong className="pt-4 pb-4">With Your consent</strong>: We may
